...
case class TrainingJob_orig(jn: String, model: com.ai.relpredict.spark.Model, conf : Config, ss : SparkSession, df : DataFrame, dm: Datamap, jobParms : Map[String, String])
